...
def mT5_load(model_name: str = "google/mt5-large") -> Tuple[transformers.MT5ForConditionalGeneration, transformers.T5Tokenizer]:
...
def polyjuice_load():
    ...
    tokenizer = transformers.AutoTokenizer.from_pretrained(
        model_path, pad_token=POLYJUICE_EOF_TOKEN,
    )
    return model, tokenizer

def roberta_mnli_load() -> Tuple[transformers.AutoModelForSequenceClassification, transformers.AutoTokenizer]:
